...
urlpatterns = [
    ...
    path(
        "incrementviews", views.IncrementViewsView.as_view(), name="api_incrementviews"
    ),
    ...
    path(
        "videos/edit/<watch_id>", views.VideoEditView.as_view(), name="api_video_edit"
    ),
    path(
        "videos/status/<watch_id>",
        views.VideoStatusView.as_view(),
        name="api_video_status",
    ),
    path(
        "videos/<channel_id>",
        views.VideoViewSet.as_view({"get": "list"}),
        name="api_videos_from_channel",
    ),
    ...
    path(
        ...
        name="api_comment_dislike",
    ),
    path(
        "comments/tickets",
        views.CommentTicketView.as_view(),
        name="api_comment_tickets",
    ),
