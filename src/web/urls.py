...
urlpatterns = [
    ...
    path(
        "channel/<channel_id>", views.ChannelFeaturedView.as_view(), name="web_channel"
    ),
    path(
        "channel/<channel_id>/featured",
        views.ChannelFeaturedView.as_view(),
        name="web_channel_featured",
    ),
    path(
        "channel/<channel_id>/videos",
        views.ChannelVideosView.as_view(),
        name="web_channel_videos",
    ),
    path(
        "channel/<channel_id>/feed",
        views.ChannelFeedView.as_view(),
        name="web_channel_feed",
    ),
    path(
        "channel_editor", views.ChannelEditorView.as_view(), name="web_channel_editor"
    ),
    ...
    path(
        ...
        name="web_dashboard_settings",
    ),
    path(
        "dashboard/videos",
        views.DashboardVideosView.as_view(),
        name="web_dashboard_videos",
    ),
    path(
        "dashboard/videos/<watch_id>",
        views.DashboardEditVideoView.as_view(),
        name="web_dashboard_edit_video",
    ),
    path(
        "dashboard/subscriptions",
        views.SubscriptionsView.as_view(),
        name="web_dashboard_subscriptions",
    ),
    path(
        "inbox/notifications",
        views.InboxNotifications.as_view(),
        name="web_inbox_notifications",
    ),
    path(
        "forgot-password", views.ResetPasswordView.as_view(), name="web_forgot_password"
    ),
    path(
    ...
    re_path(
        r"^(?P<key>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]+)/$",
